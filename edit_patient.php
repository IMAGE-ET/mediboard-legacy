...
require_once( $AppUI->getModuleClass('dPanesth', 'patientantecedent') );
...
$mode = mbGetValueFromGetOrSession("mode", "antcMain");
...
// Récupération de la liste des antécédents

$listAnt = new CPatientAntecedent;
$where = array();
$where["patient_id"] = "= '$patient->patient_id'";
$order = "debut";
$listAnt = $listAnt->loadList($where, $order);
foreach($listAnt as $key => $value) {
  $listAnt[$key]->loadRefs();
}
