  ...
  <td>
    ...
    <td>
      ...
      <table class="form">
        ...
        <tr>
          <td class="text" colspan="2">{$op.examen}</td>
        </tr>
        <tr>
          <th class="text" colspan="2">Matériel à prévoir:</th>
        </tr>
        <tr>
          <td class="text" colspan="2">{$op.materiel}</td>
        </tr>
        <tr>
    ...
    <td>
      ...
      <table class="form">
        ...
        <tr>
          <th>Admission en:</th>
          <td>
            {if $op.type_adm == "comp"} Hospitalisation complète {/if}
            {if $op.type_adm == "ambu"} Ambulatoire{/if}
            {if $op.type_adm == "exte"} Externe{/if}
          </td>
        </tr>
        <tr>
          <th>Chambre particulière:</th>
          <td>
            {if $op.chambre == "o"} Oui {/if}
            {if $op.chambre == "n"} Non {/if}
          </td>
        </tr>
        ...
        <tr>
          <td class="text" colspan="2">{$op.rques}</td>
        </tr>
