...
<tr>
  <td class="greedyPane">
    ...
    <table class="form">
      ...
      <tr>
        <th><label for="filterFrm_filter_user_id" title="Filtrer les packs pour cet utilisateur">Utilisateur:</label></th>
        <td>
  ...
  <td class="pane">
    ...
    <tr>
      <th class="mandatory"><label for="editFrm_name" title="intitulé du pack, obligatoire.">Intitulé:</label></th>
