<table class="form" id="admission">
  <tr><th colspan="2">Dr. {$admission->_ref_chir->user_last_name} {$admission->_ref_chir->user_first_name}</th></tr>
  ...
  <tr><th>Nom / Prenom du patient: </th><td>{$admission->_ref_pat->nom} {$admission->_ref_pat->prenom}</td></tr>
