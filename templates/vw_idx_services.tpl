...
<tr>
  ...
  <td class="halfPane">
    ...
    <tr>
      <th class="mandatory"><label for="editFrm_nom" title="intitulé du service, obligatoire.">Intitulé:</label></th>
      <td><input type="text" name="nom" value="{$serviceSel->nom}" /></td>
    </tr>
    
    <tr>
      <th><label for="editFrm_description" title="Description du service, responsabilités, lignes de conduite.">Description:</label></th>
