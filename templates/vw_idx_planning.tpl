<table class="main">
  ...
  <tr>
    <th>
	  <a href="index.php?m={$m}&tab=0&day={$pmonthd}&month={$pmonth}&year={$pmonthy}"><<</a>
	  {$title1}
	  <a href="index.php?m={$m}&tab=0&day={$nmonthd}&month={$nmonth}&year={$nmonthy}">>></a>
	</th>
	<th>
	  <a href="index.php?m={$m}&tab=0&day={$pday}&month={$pdaym}&year={$pdayy}"><<</a>
	  {$title2}
    ...
    <td>
	  <table class="color">
		...
		<tr style="background: #fff">
		  <td align="right">
		    <a href="index.php?m={$m}&tab=0&day={$curr_plage.day}&month={$month}&year={$year}">
			{$curr_plage.date}
			</a>
		  </td>
		  <td align="center">
