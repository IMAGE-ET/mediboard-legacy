...
<ol>
  ...
  <li>Pour chaque import, placer le fichier TXT correspondant dans la racine du module dPinterop.
    <ul>
      <li><a href="javascript:doAction('dermato_patients')">Import des patients</a> : PATIENT.TXT, (le concaténer avec PATIENT_RDV.TXT)</li>
      <li><a href="javascript:doAction('dermato_praticiens')">Import des praticiens</a> : PRATICIEN.TXT</li>
      <li><a href="javascript:doAction('dermato_medecins')">Import des médecins traitants</a> : MED_TRAITANT.TXT</li>
      ...
      <li><a href="javascript:doAction('dermato_rdv');">Import RDV à venir</a> : RDV.TXT</li>
    </ul>
  </li>
  <li>
  ...
  <li>
    ...
    <ul>
      <li><a href="javascript:doAction('dermato_put_praticiens')">Envoie des praticiens vers Mediboard</a> (!! Attention, il faut le faire à la main !!)</li>
      ...
      <li><a href="javascript:doAction('dermato_put_rdv')">Envoie des rdv à venir vers Mediboard</a></li>
    </ul>
  </li>
